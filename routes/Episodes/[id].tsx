...
export const handler: Handlers<Data> = {
  GET: async (_req, ctx) => {
    ...
    try {
      ...
      const episode = await Axios.get(`https://rickandmortyapi.com/api/episode/${id}`);
      ...
      return ctx.render({ characters, episodeName: episode.data.name });
    } catch (error) {
...
export default function EpisodePage({ data }: PageProps<Data>) {
  return (
    <div className="Layout">
      ...
      <CharactersContainer characters={data.characters} />
    </div>
  );
}